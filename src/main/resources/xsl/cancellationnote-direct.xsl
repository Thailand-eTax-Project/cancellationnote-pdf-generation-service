...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/rsm:CancellationNote_CrossIndustryInvoice">
        ...
        <fo:root>
            <fo:layout-master-set>
                <fo:simple-page-master master-name="cancellationnote-page"
            ...
            <fo:page-sequence master-reference="cancellationnote-page">
                <!-- Header -->
                                ...
                                <fo:table-row>
                                    ...
                                    <fo:table-cell>
                                        <fo:block text-align="right">
                                            ใบแจ้งยกเลิก / CANCELLATION NOTE
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </fo:table-body>
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell padding="2mm" border="0.5pt solid #dddddd" background-color="#e8e8e8">
                                    ...
                                    <fo:block font-size="{$font-size-small}">Cancellation Note No.</fo:block>
                                </fo:table-cell>
