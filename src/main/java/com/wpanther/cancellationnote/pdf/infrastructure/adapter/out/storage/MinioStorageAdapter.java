...
public class MinioStorageAdapter implements PdfStoragePort {
    ...
    public String store(String cancellationNoteNumber, byte[] pdfBytes) {
        return storeTimer.record(() -> doStore(cancellationNoteNumber, pdfBytes));
    }
    ...
    private String doStore(String cancellationNoteNumber, byte[] pdfBytes) {
        LocalDate now = LocalDate.now();
        String safeName = sanitizeFilename(cancellationNoteNumber);
        String fileName = String.format("cancellationnote-%s-%s.pdf", safeName, UUID.randomUUID());
