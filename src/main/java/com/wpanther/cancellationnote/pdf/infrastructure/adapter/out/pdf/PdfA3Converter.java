...
public class PdfA3Converter {
     ...
     * @param xmlFilename            The filename for the embedded XML (e.g., "cancellationnote.xml")
     * @param cancellationNoteNumber The cancellation note number for metadata
     * @return PDF/A-3 compliant PDF bytes with embedded XML
     * @throws CancellationNotePdfGenerationException if conversion fails
     */
    public byte[] convertToPdfA3(byte[] pdfBytes, String xmlContent, String xmlFilename, String cancellationNoteNumber)
        ...
        try (PDDocument document = Loader.loadPDF(pdfBytes)) {
            ...
            addPdfAMetadata(document, cancellationNoteNumber);
            ...
            throw new CancellationNotePdfGenerationException("PDF/A-3 conversion failed: " + e.getMessage(), e);
        } finally {
     ...
     */
    private void addPdfAMetadata(PDDocument document, String cancellationNoteNumber) throws Exception {
        ...
        dc.setTitle("Thai e-Tax Cancellation Note: " + cancellationNoteNumber);
